from SDN.sdn_functions import *
import time

import subprocess, socket
from datetime import datetime, timezone
from sqlmodel import SQLModel, Field, create_engine, Session
from SFLOW.classess import data
#sflow_data ={}
# DB conf
DB_HOST = "127.0.0.1"
DB_PORT = 3308
...
def sflow_stream():
    ...
    for line in proc.stdout:
        ...
        if line.startswith("agent"):
            ...
            src_ip, dst_ip, src_port, dst_port, proto = extract_ips_from_header_bytes_and_replace_with_something_more_humanReadable_plz_thanks(ermWhatThe_Header)
            if src_ip and dst_ip:
                ...
                tempdict = {"src_ip": src_ip,"dst_ip": dst_ip,"src_port": src_port,"dst_port": dst_port,"proto": proto,"timestamp": current_time}
                analysis = analyze_netflow_data(analysis, tempdict)
